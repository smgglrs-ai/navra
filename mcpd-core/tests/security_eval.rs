...
use mcpd_core::auth::chain::{CapabilityAuthenticator, ChainAuthenticator};
use mcpd_core::auth::{AgentIdentity, AuthError, Authenticator, TokenAuthenticator};
use mcpd_core::identity::{CapSigner, Ed25519Signer};
use mcpd_core::credentials::{CredentialMapping, CredentialStore, MappedCredentialStore};
...
mod quota {
    use mcpd_core::quota::{QuotaEngine, RateLimit};
