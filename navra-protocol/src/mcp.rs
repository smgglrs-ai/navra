...
mod tests {
    ...
    fn roundtrip_initialize_result() {
        ...
        assert_eq!(parsed.protocol_version, PROTOCOL_VERSION);
        assert_eq!(parsed.server_info.name, "navra");
