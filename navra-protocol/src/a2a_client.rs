...
//! Supports IFC label propagation via `X-Navra-DataLabel` header
...
pub const DATA_LABEL_HEADER: &str = "X-Navra-DataLabel";
...
mod tests {
    use super::*;
    use crate::a2a::{
        Message, MessageKind, MessageRole, Part, Task, TaskKind, TaskState, TaskStatus,
    };
    ...
    fn data_label_header_constant() {
        assert_eq!(DATA_LABEL_HEADER, "X-Navra-DataLabel");
    }
