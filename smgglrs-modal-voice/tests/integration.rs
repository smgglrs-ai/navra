//! Integration tests for smgglrs-modal-voice public API.
//!
//! Tests VoiceModule construction, tool definitions, and audio utilities.

use smgglrs_core::models::{
    ModelBackend, ModelError, SynthesizeRequest, SynthesizeResponse, TranscribeRequest,
    TranscribeResponse,
};
use smgglrs_core::permissions::PermissionEngine;
use smgglrs_core::Module;
use smgglrs_modal_voice::audio;
use smgglrs_modal_voice::VoiceModule;
use std::sync::Arc;
