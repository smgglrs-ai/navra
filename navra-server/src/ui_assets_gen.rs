...
const ASSET_ASSETS_INDEX_BUOIRRDM_CSS: &[u8] =
    include_bytes!("../ui-dist/assets/index-BuoIrrDM.css");
...
pub fn get_asset(path: &str) -> Option<(&'static [u8], &'static str)> {
    match path {
        ...
        "/assets/index-DFUB4QPn.js" => {
            Some((ASSET_ASSETS_INDEX_DFUB4QPN_JS, "application/javascript"))
        }
