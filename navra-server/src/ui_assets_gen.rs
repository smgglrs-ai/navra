...
const ASSET_ASSETS_INDEX_B9X186DI_CSS: &[u8] = include_bytes!("../ui-dist/assets/index-B9x186dI.css");
...
pub fn get_asset(path: &str) -> Option<(&'static [u8], &'static str)> {
    match path {
        ...
        "/assets/index-DbhN8_SZ.js" => Some((ASSET_ASSETS_INDEX_DBHN8_SZ_JS, "application/javascript")),
