...
CLI binary and module wiring for the navra MCP gateway.

## Overview

The `navra` binary that ties the entire workspace together. Loads
...
All navra-* crates
    |
navra-server  (top of the dependency graph)
```
