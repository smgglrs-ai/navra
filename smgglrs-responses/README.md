...
```
smgglrs-responses  (standalone -- no smgglrs deps, minimal deps)
    |
smgglrs-model      (uses as canonical model I/O interface)
```

## Reference

See [DESIGN.md](../DESIGN.md) for how Open Responses integrates
into the smgglrs model backend architecture.
