...
const BOUNDARIES_4BIT: &[f32] = &[
    0.0, 0.1135, 0.2533, 0.3979, 0.5489, 0.7084, 0.8791, 1.0640, 1.2676, 1.4968, 1.7618,
    2.0801, 2.4817, 3.0275, 3.8913, 5.8572,
];
const CENTERS_4BIT: &[f32] = &[
    0.0564, 0.1822, 0.3245, 0.4723, 0.6275, 0.7925, 0.9700, 1.1638, 1.3797, 1.6260, 1.9159,
    2.2717, 2.7344, 3.4049, 4.6194, 7.6146,
];
