...
repo_license = "Apache-2.0 · Rust · 23 crates · ~150K LoC"
...
content = "23-crate Rust workspace. Security kernel enforces access control at a single chokepoint. Tool modules run in-process or as standalone MCP servers for crash isolation."
