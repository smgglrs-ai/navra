+++
title = "Composite Model Cards for Agentic AI: Bridging Registry Metadata and Runtime Selection"
weight = 10
...
The artifact type is `application/vnd.navra.model-card.v1+json`,
...
side artifacts of type `application/vnd.navra.model-card.v1+json`.
