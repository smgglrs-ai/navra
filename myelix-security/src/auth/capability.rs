...
//!
//! Token wire format: `mcpd_cap_v1.<base64url(cbor)>.<base64url(sig)>`
//!
...
const TOKEN_PREFIX: &str = "mcpd_cap_v1";
...
///
/// Returns the wire-format string: `mcpd_cap_v1.<cbor>.<sig>`
...
mod tests {
    ...
    fn roundtrip_encode_decode() {
        ...
        assert!(token.starts_with("mcpd_cap_v1."));
    ...
    fn invalid_format_rejected() {
        ...
        assert!(decode_token("mcpd_cap_v1.only-two", &signer).is_err());
