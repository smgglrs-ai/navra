...
mod tests {
    use super::*;
    use smgglrs_model::{ClassifyLabel, ClassifyResponse, ModelError};
    ...
    impl smgglrs_model::ModelBackend for MockClassifier {
        fn classify(
            &self,
    ...
    impl smgglrs_model::ModelBackend for FailingClassifier {
        fn classify(
            &self,
            _request: &ClassifyRequest,
        ) -> std::pin::Pin<
