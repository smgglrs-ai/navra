...
//! - **Advertise** mcpd on the LAN so other agents can find it
...
/// Advertise mcpd on the local network via mDNS.
///
...
/// Get the system hostname (fallback to "mcpd").
fn hostname() -> String {
    std::env::var("HOSTNAME")
        ...
        .unwrap_or_else(|_| "mcpd".to_string())
}
