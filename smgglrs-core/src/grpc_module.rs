...
pub mod proto {
    tonic::include_proto!("smgglrs.module.v1");
}
...
fn parse_data_label(s: &str) -> smgglrs_protocol::label::DataLabel {
...
mod tests {
    ...
    fn parse_data_label_untrusted_pii() {
        ...
        assert_eq!(label, smgglrs_protocol::label::DataLabel::UNTRUSTED_PII);
    }

    #[test]
    fn parse_data_label_trusted_secret() {
        let label = parse_data_label("Trusted+Secret");
        assert_eq!(label, smgglrs_protocol::label::DataLabel::TRUSTED_SECRET);
    }
