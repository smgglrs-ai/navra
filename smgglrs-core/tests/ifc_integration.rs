...
async fn clean_write_allowed_after_tainted_read() {
    ...
    // Use smgglrs_var_list (gateway tool, excluded from is_external_read_tool
...
async fn context_label_persists_across_calls() {
    ...
    assert_eq!(
        ...
        smgglrs_core::ifc::Integrity::Untrusted,
...
impl OllamaContainer {
    ...
    fn start() -> Option<Self> {
        ...
        let name = format!("smgglrs-test-ollama-{}", std::process::id());
